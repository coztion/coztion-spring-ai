package coztion.springai.core.claude.application.model.command;
...
@NoArgsConstructor
@AllArgsConstructor
public class ClaudeGenerateCommand {

    private ClaudePrompt prompt;
    ...
    @Getter
    @Setter
    public static class ClaudePrompt {
